...
const years = [...Array(new Date().getFullYear() - 1989).keys()].map(
    (e) => e + 1990
);
    ...
    const removeDao = useCallback(
        (val) => () => {
            setValuesDao((previousTags) =>
                previousTags.filter(
                    (previousTag, index) => previousTag.value !== val
                )
            );
        },
        []
                        ...
                        >
                            ...
                            <Row className='mb-3'>
                                <Form.Group as={Col} controlId='formGridExp'>
                                    <Form.Label>
                                        Experience and Tasks Accomplished
                                    </Form.Label>
                                    <Form.Control
                                        required
                                        as='textarea'
                            ...
                            <Row className='mb-3'>
                                <Form.Group
                                    as={Col}
                                    controlId='formGridStartDateMonth'
                                >
                                ...
                                <Form.Group
                                    as={Col}
                                    controlId='formGridStartDateYear'
                                >
                            ...
                            {!user.currWorkRole ? (
                                <Row className='mb-3'>
                                    <Form.Group
                                        as={Col}
                                        controlId='formGridEndDateMonth'
                                    >
                                        <Form.Label
                                            name='endDate'
                            ...
                            <Row className='mb-5 mbl-full'>
                                ...
                                >
                                    <Form.Label>
                                        <strong>
                                            Hours Per Week Committed on Average
                                        </strong>
                                    </Form.Label>
                                    <Form.Control
                                        type='text'
