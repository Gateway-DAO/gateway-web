...
const validationSchema = yup.object().shape({
    title: yup.string().required('Gate Title is Required!'),
    description: yup.string().required('Gate Description is Required.'),
    keyRequired: yup
        .number()
        .min(0, 'keys required for Gate')
...
const AddGateForm = (props) => {
    ...
    */
    ...
    the input. */
    const addCategories = (e, setFieldValue, category) => {
        if (e.key === 'Enter') {
                            ...
                            {!uploadFile ? (
                                ...
                                >
                                    <Styled.DragAreaText
                                        ...
                                        className='header'
                                    >
                                        <Styled.Span> Upload </Styled.Span>or
